...
const traits = [
  {
    ...
    detail:
      '생명과학 → B2B 세일즈 → AI 개발로의 전환은 "해보면서 배운다"는 태도의 증거입니다. 회신율이 낮자 AI 챗봇을 직접 개발했고, 팀 전체의 아웃바운드 역량을 높이기 위해 자동화 시스템을 직접 만들어 배포했습니다.',
  ...
  },
  {
    ...
    detail:
      'CliftonStrengths Top 5가 전부 "대인관계·영향력" 영역입니다. 개인 성과에 그치지 않고 팀 전체가 쓸 수 있는 시스템을 만드는 것을 중요하게 여깁니다. ENFJ 특유의 리더십이 영업 조직 안에서 자연스럽게 발현됩니다.',
  ...
  },
  {
    ...
    detail:
      '친구들이 "의외로 신중한 스타일"이라고 표현합니다. 브라운백에서 고객 머무름 데이터를 분석해 콜드메일 3종을 A/B 테스트했고, 포트원에서는 SalesClue로 제안서 열람 데이터를 추적해 전략을 수정했습니다. 직관처럼 보이는 행동 뒤에는 항상 데이터가 있습니다.',
  ...
  },
  {
    ...
    detail:
      '야구·댄스·우드카빙·AI개발·유튜브 — 겉으로는 다 달라 보이지만 "좋아하면 깊이 파고드는" 패턴 하나로 관통됩니다. 이 패턴이 영업에서는 자동화 도구 개발로, 팀에서는 시스템 구축으로 나타납니다. 조직에 들어오면 존재감이 선명한 사람입니다.',
      ...
      <div style={{ maxWidth: 900, margin: '0 auto' }}>
        ...
        <div className="reveal" style={{ marginBottom: 56 }}>
          ...
          <p style={{ fontSize: 15, color: 'var(--color-muted)', maxWidth: 600, lineHeight: 1.7 }}>
            이력서의 숫자 너머, 함께 일하게 될 사람이 어떤 사람인지 — 업무 데이터와 주변 사람들의 시각을 함께 정리했습니다.
          </p>
        </div>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20, marginBottom: 56 }}>
          {traits.map((trait, i) => (
            ...
            >
              ...
              {/* 본문 */}
              <p style={{ fontSize: 14, lineHeight: 1.75, color: 'var(--color-secondary)', margin: '12px 0 16px', paddingLeft: 52 }}>
                {trait.detail}
              </p>
